...
/*
 * The Search!! This accesses the API and parses JSON objects to get book information
...
public class Search_Book extends AppCompatActivity {
    ...
    public void goalsClicked(View view) {
        startActivity(new Intent(Search_Book.this, Goals_Activity.class));
    }
    ...
    public void statsClicked(View view) {
        startActivity(new Intent(Search_Book.this, Stats_Activity.class));
    }
    public void booksClicked(View view) {
        startActivity(new Intent(Search_Book.this, Books_Activity.class));
    }
    ...
    private void getBooksInfo(String query) {
        ...
        mRequestQueue = Volley.newRequestQueue(Search_Book.this);
        ...
        RequestQueue queue = Volley.newRequestQueue(Search_Book.this);
        ...
        JsonObjectRequest booksObjrequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < itemsArray.length(); i++) {
                        ...
                        BookAdapter adapter = new BookAdapter(bookInfoArrayList, Search_Book.this);

                        // below line is use to add linear layout
                        // manager for our recycler view.
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Search_Book.this, RecyclerView.VERTICAL, false);
                    ...
                    Toast.makeText(Search_Book.this, "No Data Found" + e, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Search_Book.this, "Error found is " + error, Toast.LENGTH_SHORT).show();
            }
        });
